...
databricks bundle run  download_files   --params="day=02"   --params="month=09"   --params="year=2025"   --params="base_url=https://d37ci6vzurychx.cloudfront.net/trip-data/"   --params="raw_path=/Volumes/nyc_taxi/bronze/raw_data/"   
